...
class CreateVersionCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $rule = $ruleService->getRules($contract, $group, $property, $version);
        $versionEtag = $rule['etag'];
        
        $response = $versionService->createVersion($contract, $group, $property, $version, $versionEtag);
    ...
    protected function configure()
    {
        ...
        $this->setName('akamai:createversion');
        $this->setDescription('Create version for a property');
